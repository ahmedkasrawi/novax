      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          <div className="space-y-4">
            <span className="inline-block text-sm font-semibold tracking-[0.35em] text-slate-100 uppercase mb-4">
              <span className="text-(--main-color) font-extrabold text-lg">A</span>Store
            </span>
